...
using Thaco.Peugeot.Web.Models.Account;
using Thaco.Peugeot.Web.Views.Shared.Components.TenantChange;

namespace Thaco.Peugeot.Web.Controllers
{
    public class AccountController : PeugeotControllerBase
    {
